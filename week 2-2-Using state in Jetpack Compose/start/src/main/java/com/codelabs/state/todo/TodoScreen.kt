...
@Composable
fun TodoItemEntryInput(onItemComplete: (TodoItem) -> Unit, buttonText: String = "추가") {
...
fun PreviewTodoScreen() {
    val items = listOf(
        TodoItem("컴포즈 공부하기", TodoIcon.Event),
        TodoItem("코드랩수료하기!!"),
        TodoItem("1", TodoIcon.Done),
        TodoItem("2", TodoIcon.Square)
    )
